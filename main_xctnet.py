...
from xctnet.model import XctNet, ResidualBlock
...
class DXRLightningModule(LightningModule):
    ...
    def forward_volume(self, image2d, cameras, n_views=[2, 1], resample=False, timesteps=None):
        ...
        results = self.inv_renderer(image2d) #.view(-1, 1, self.vol_shape, self.vol_shape, self.vol_shape)
        return results

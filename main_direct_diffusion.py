...
class DXRLightningModule(LightningModule):
    ...
    def configure_optimizers(self):
        ...
        g_sch = torch.optim.lr_scheduler.MultiStepLR(g_opt, milestones=[100, 200], gamma=0.5)
        d_sch = torch.optim.lr_scheduler.MultiStepLR(d_opt, milestones=[100, 200], gamma=0.5)

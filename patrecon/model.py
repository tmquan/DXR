...
def conv4x4x4(in_planes, out_planes, stride=2):
    return nn.Conv3d(in_planes, out_planes, kernel_size=4, stride=stride, padding=1, bias=False)


# 2D Deconv
def deconv1x1(in_planes, out_planes, stride):
    return nn.ConvTranspose2d(in_planes, out_planes, kernel_size=1, stride=stride, padding=0, output_padding=0, bias=False,)


def deconv2x2(in_planes, out_planes, stride):
    return nn.ConvTranspose2d(in_planes, out_planes, kernel_size=2, stride=stride, padding=0, output_padding=0, bias=False,)


def deconv3x3(in_planes, out_planes, stride):
    return nn.ConvTranspose2d(in_planes, out_planes, kernel_size=3, stride=stride, padding=1, output_padding=0, bias=False,)


def deconv4x4(in_planes, out_planes, stride):
    return nn.ConvTranspose2d(in_planes, out_planes, kernel_size=4, stride=stride, padding=1, output_padding=0, bias=False,)


# 3D Deconv
def deconv1x1x1(in_planes, out_planes, stride):
    return nn.ConvTranspose3d(in_planes, out_planes, kernel_size=1, stride=stride, padding=0, output_padding=0, bias=False,)


def deconv3x3x3(in_planes, out_planes, stride):
    return nn.ConvTranspose3d(in_planes, out_planes, kernel_size=3, stride=stride, padding=1, output_padding=0, bias=False,)


def deconv4x4x4(in_planes, out_planes, stride):
    return nn.ConvTranspose3d(in_planes, out_planes, kernel_size=4, stride=stride, padding=1, output_padding=0, bias=False,)
...
class ReconNet(nn.Module):
    def __init__(self, in_channels, out_channels, gain=0.02, init_type="standard"):
        ...
        self.conv_layer3 = _make_layers(256, 512, "conv4_s2", "2d", "leakyrelu")
        self.conv_layer4 = _make_layers(512, 512, "conv3_s1", "2d")
        self.relu4 = nn.ReLU(inplace=True)
        self.conv_layer5 = _make_layers(512, 1024, "conv4_s2", "2d", "leakyrelu")
        self.conv_layer6 = _make_layers(1024, 1024, "conv3_s1", "2d")
        self.relu6 = nn.ReLU(inplace=True)
        self.conv_layer7 = _make_layers(1024, 2048, "conv4_s2", "2d", "leakyrelu")
        self.conv_layer8 = _make_layers(2048, 2048, "conv3_s1", "2d")
        self.relu8 = nn.ReLU(inplace=True)
        self.conv_layer9 = _make_layers(2048, 4096, "conv4_s2", "2d", "leakyrelu")
        self.conv_layer10 = _make_layers(4096, 4096, "conv3_s1", "2d")
        self.relu10 = nn.ReLU(inplace=True)

        ######### transform module
        self.trans_layer1 = _make_layers(4096, 4096, "conv1_s1", False, "leakyrelu")
        self.trans_layer2 = _make_layers(2048, 2048, "deconv1x1_s1", False, "leakyrelu")

        ######### generation network - deconvolution layers
        self.deconv_layer10 = _make_layers(2048, 1024, "deconv4x4_s2", "3d", "leakyrelu")
        self.deconv_layer8 = _make_layers(1024, 512, "deconv4x4_s2", "3d", "leakyrelu")
        self.deconv_layer7 = _make_layers(512, 512, "deconv3x3_s1", "3d", "leakyrelu")
        self.deconv_layer6 = _make_layers(512, 256, "deconv4x4_s2", "3d", "leakyrelu")
        self.deconv_layer5 = _make_layers(256, 256, "deconv3x3_s1", "3d", "leakyrelu")
        self.deconv_layer4 = _make_layers(256, 128, "deconv4x4_s2", "3d", "leakyrelu")
        self.deconv_layer3 = _make_layers(128, 128, "deconv3x3_s1", "3d", "leakyrelu")
        self.deconv_layer2 = _make_layers(128, 64, "deconv4x4_s2", "3d", "leakyrelu")
        self.deconv_layer1 = _make_layers(64, 64, "deconv3x3_s1", "3d", "leakyrelu")
        self.deconv_layer0 = _make_layers(64, 1, "conv1x1_s1", False, "leakyrelu")
    ...
    def forward(self, x, out_feature=False):
        ...
        # trans_features = features.view(-1, 2048, 2, 4, 4) # For 128^3 volume
        trans_features = features.view(-1, 2048, 2, 8, 8)  # For 256^3 volume

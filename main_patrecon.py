...
class DXRLightningModule(LightningModule):
    def __init__(self, hparams, **kwargs):
        ...
        self.inv_renderer = ReconNet(in_channels=1, out_channels=self.vol_shape, gain=0.02, init_type="standard")
    ...
    def _common_step(self, batch, batch_idx, optimizer_idx, stage: Optional[str] = "evaluation"):
        ...
        if batch_idx == 0:
            ...
            viz2d = torch.cat([torch.cat([image2d, volume_xr_hidden[..., self.vol_shape // 2, :], figure_xr_hidden_hidden, image3d[..., self.vol_shape // 2, :], figure_ct_hidden, volume_ct_hidden[..., self.vol_shape // 2, :], figure_ct_hidden_hidden,], dim=-2,).transpose(2, 3),], dim=-2,)

...
class DirectVolumeRenderer(nn.Module):
    def __init__(
        ...
        self.raysampler = NDCMultinomialRaysampler(
            image_width=image_width, image_height=image_height, n_pts_per_ray=n_pts_per_ray, min_depth=min_depth, max_depth=max_depth, stratified_sampling=stratified_sampling,
        )
